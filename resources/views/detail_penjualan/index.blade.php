...
@includeIf('detail_penjualan.produk')
@endsection
...
<script>
    ...
    $(function () {
        ...
        $(document).on('change', '.quantity', function () {
            var jumlah = $(this).val();
            var idDetailPenjualan = $(this).data('id');

            // Konversi jumlah menjadi integer
            var jumlahInt = parseInt(jumlah);

            // Validasi apakah jumlah adalah angka
            if (!isNaN(jumlahInt) && jumlahInt > 0) {
                $.ajax({
                    url: '/transaksi/' + idDetailPenjualan,
                    method: 'PUT',
                    data: {
                    ...
                    success: function(response) {
                        ...
                        table.ajax.reload(() => loadForm($('#diskon').val())); // Reload table setelah update
                    },
                    error: function(xhr) {
                        // Tangani kesalahan
