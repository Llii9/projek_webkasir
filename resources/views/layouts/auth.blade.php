...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('admin1/plugins/iCheck/square/blue.css') }}">
  ...
  <!-- Include any additional stylesheets defined in child views -->
  @yield('styles')
...
<!-- iCheck -->
<script src="{{ asset('admin1/plugins/iCheck/icheck.min.js') }}"></script>
<script>
  $(function () {
    $('input').iCheck({
